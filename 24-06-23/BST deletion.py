...
def insert(node,key):
    ...
    return node
#given a non empty binary search tree return the node with minum key value
#found in that tree node that the entire tree does not need to be searched
...
def deleteNode(root,key):
    ...
    # if key is same as root key then this is to be deleted
    else:
        ...
        #(smallest in the right sub tree)
